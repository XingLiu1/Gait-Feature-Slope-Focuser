...
# 定义不同的 act 类别及其对应的参数
act_parameters = {
    '启动停止+正常行走': {'distance': 30, 'height': 9},
    '帕金森':  {'distance': 40, 'height': 7},
    '弯曲僵硬': {'distance': 40, 'height':0},
    '快速启停+转弯': {'distance': 60, 'height': 8},
    '快速启动+停止（3步一次）':  {'distance': 30, 'height': 6},
    '拖地': {'distance': 90, 'height': 0},
    '正常行走+转弯': {'distance': 60, 'height': 0},
    '正常走': {'distance': 20, 'height': 10},
    '画圈': {'distance': 60, 'height': 8},
...
dfGT.to_csv("../dfHSGT.csv", index=False)
